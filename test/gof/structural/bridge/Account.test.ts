...
test("Não deve criar uma conta de usuário do tipo passageiro com o nome inválido", function () {
    expect(() => new Passenger("John", "john.doe@gmail.com", "11111111111", "JOHN DOE", "1111 1111 1111 1111", "08/28", "123", "123456"))
    .toThrow(new Error("Invalid name!"));
});

test("Não deve criar uma conta de usuário do tipo passageiro com o email inválido", function () {
    expect(() => new Passenger("John Doe", "john.doe@gmail", "11111111111", "JOHN DOE", "1111 1111 1111 1111", "08/28", "123", "123456"))
...
test("Não deve criar uma conta de usuário do tipo passageiro com o documento inválido", function () {
    expect(() => new Passenger("John Doe", "john.doe@gmail.com", "1111111111", "JOHN DOE", "1111 1111 1111 1111", "08/28", "123", "123456"))
...
test("Não deve criar uma conta de usuário do tipo passageiro com o cvv inválido", function () {
    expect(() => new Passenger("John Doe", "john.doe@gmail.com", "11111111111", "JOHN DOE", "1111 1111 1111 1111", "08/28", "1", "123456"))
...
test("Deve criar uma conta de usuário do tipo motorista", function () {
    ...
    expect(account.name).toBe("John Doe");
    expect(account.email).toBe("john.doe@gmail.com");
    expect(account.carPlate).toBe("AAA9999");
});

test("Não deve criar uma conta de usuário do tipo motorista com placa do veículo inválido", function () {
    expect(() => new Driver("John Doe", "john.doe@gmail.com", "11111111111", "AAA999A", "123456"))
