...
insert into design_patterns.room (room_id, category, price, status) values(4, 'suite', 300, 'maintenance');
...
insert into design_patterns.booking values('abc', 1, 'john.doe@mail.com', '2024-03-10T10:00:00', '2024-03-12T10:00:00', 2, 1000, 'confirmed');