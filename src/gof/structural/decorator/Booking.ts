...
export default class Booking {
    ...
    constructor (readonly code: string, readonly roomId: number, readonly email: string,
        readonly checkinDate: Date, readonly checkoutDate: Date,
        readonly duration: number, readonly price: number, private status: string) {
